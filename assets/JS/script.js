// Controllo: funziona? vedo qualcosa in console? ho collegato file JS e HTML?
...
let kilometers, price_km_based, output_price, user_price, age
  ...
  // Aks User for kilometers amount - PROMPT()
  // convert from string to number - NUMBER()
  // store the value in a variable
  kilometers = Number(prompt('How many kilometers long is your railway route?')); 
  // console.log(kilometers)

  // Aks User for traveler age - PROMPT
  // convert from string to number - NUMBER()
  // store the value in a variable
  age = Number(prompt('How old is the passenger?'));  
  // console.log(age)    
...
// Determin total ticket price amount
  ...
  // Convert final price into a human friendly form: 
